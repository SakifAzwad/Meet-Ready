const CardCalosal = ({name, content, name1}) => {
    return (
      <div className="px-6 h-72 py-6 relative max-w-[350px] text-white bg-gradient-to-r overflow-hidden from-[#d20bd5] via-[#cb6cc8] to-[#bb24ae] group rounded-lg shadow-2xl">
