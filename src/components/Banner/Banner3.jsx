...
const Banner3 = () => {
  return (
    <div className="mb-4 pt-20" data-testid="homeBanner3">
      <h1 className="text-center  text-purple-900 lg:text-5xl text-3xl font-bold">
        Discover all our Integrations
      </h1>
      <Marquee className="py-20">
        <div className="mx-8">
          <img
            width="184"
            height="184"
            loading="lazy"
            className="h-15 w-15 md:h-20 hover:opacity-80 md:w-20 lg:w-[92px] lg:h-[92px] object-cover"
