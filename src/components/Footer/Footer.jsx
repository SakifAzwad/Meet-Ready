...
<footer className=" font-sans lg:px-40">
  <div className="container px-6 py-12 mx-auto">
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
          ...
          <div>
              ...
              <div className="flex flex-col items-start mt-5 space-y-2">
                  <p className="text-black transition-colors duration-300  dark:hover:text-purple-400 hover:underline hover:cursor-pointer hover:text-col1">Home</p>
                  <p className="text-black transition-colors duration-300  dark:hover:text-purple-400 hover:underline hover:cursor-pointer hover:text-col1">Who We Are</p>
                  <p className="text-black transition-colors duration-300  dark:hover:text-purple-400 hover:underline hover:cursor-pointer hover:text-col1">Our Philosophy</p>
              </div>
          </div>
          ...
          <div>
              ...
              <div className="flex flex-col items-start mt-5 space-y-2">
                  <p className="text-black transition-colors duration-300  dark:hover:text-purple-400 hover:underline hover:cursor-pointer hover:text-col1">Retail & E-Commerce</p>
                  <p className="text-black transition-colors duration-300  dark:hover:text-purple-400 hover:underline hover:cursor-pointer hover:text-col1">Information Technology</p>
                  <p className="text-black transition-colors duration-300  dark:hover:text-purple-400 hover:underline hover:cursor-pointer hover:text-col1">Finance & Insurance</p>
              </div>
          </div>
      ...
      <p className="font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2024 Meet-Ready Inc. All rights reserved.</p>
  </div>
</footer>
      </div>
  );
